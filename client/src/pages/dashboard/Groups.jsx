...
export default function Groups() {
  ...
  const handleAttachFile = async (e) => {
    ...
    try {
      ...
      const uploadToastId = toast.loading(`Encrypting & uploading ${file.name}...`);
      ...
      toast.error("Failed to encrypt or upload attachment.");
    } finally {
  ...
  return (
    <div className="flex h-dvh bg-slate-50 overflow-hidden relative font-sans">
